                ...
                <div class="p-8 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button id="filterBtn" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg transition-all duration-200 flex items-center shadow-md hover:shadow-lg">
                        ...
                        <table id="studentTable" class="w-full border-collapse">
                            <thead>
                                <tr class="bg-blue-50 text-blue-700 uppercase text-sm">
                                    ...
                                    <th class="px-4 py-3 text-left border-b border-blue-200 font-semibold">Jenis Kelamin</th>
